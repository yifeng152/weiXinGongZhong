...
$robotInfoList = "现在您可以和小南聊天了（输入“#”返回主界面）";

$weatherInfoList = "请输入您要查询的城市或者您当前所在的\"位置\"（输入“#”返回主界面）";

$noteInfoList = "现在已进入记事本模式，您输入的内容将会被记录到记事本中\n（仅输入“#”返回主界面;\n仅输入“查看”查看记事本）";//wq 2015-07-06

$jokeInfoList = "现在已进入笑话模式，发送任意信息即可收到一个笑话（输入“#”返回主界面）";

$suggestionInfoList = "欢迎您提出宝贵意见，分享您找到的bug（输入“#”返回主界面）";
